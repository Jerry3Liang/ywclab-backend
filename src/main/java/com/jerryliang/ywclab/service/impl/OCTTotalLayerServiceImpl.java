...
public class OCTTotalLayerServiceImpl implements OCTTotalLayerService {
    ...
    public List<Double> getOCTTotalFinalData(Sheet sheet) {
        ...
        dataList.add(map.get(thickness1));
        dataList.add(map.get(thickness2));
        dataList.add(map.get(thickness3));
        dataList.add(map.get(thickness4));
        dataList.add(map.get(thickness5));
        dataList.add(map.get(thickness6));
        dataList.add(map.get(thickness7));
        dataList.add(map.get(thickness8));
        dataList.add(map.get(thickness9));
        dataList.add(map.get(thickness10));
        dataList.add(map.get(thickness11));
        dataList.add(map.get(thickness12));
        dataList.add(map.get(thickness13));
        dataList.add(map.get(thickness14));
        dataList.add(map.get(thickness15));
        dataList.add(map.get(thickness16));
        dataList.add(map.get(thickness17));
